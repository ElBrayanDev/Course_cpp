/*
#FUNTION CALLS - Functions use the 'function call stack'
...
#Stack Frame or Activation Record
    ...
    - When a function terminates we pop the activation record and return *Local variables and function parameters are allocated on the stack
