...
Be careful with Default arguments, if you default 2 functions, compiler error for "ambiguous"

You can have the same name for 2 or more functions, but the compiler will call
the function that matches the types of the attributes.
