...
array.front();
array.back();
array.empty() - boolean, checks if is empty
array.max_size() - int
array.swap(array2)
arr.data(); - * pointer to raw array address
*/
...
void test4()
{
    ...
    std::sort(arr1.begin(), arr1.end()); // # Algorithm
    display(arr1);
}
...
void test7()
{
    ...
    int sum = std::accumulate(arr1.begin(), arr1.end(), 3); // # starts sum from 0
...
void test9()
{
    ...
    //! find how many numbers are between 10 and 200 ->  50,60,70,80 with lambda exp
